...
class LLFFDataset(Dataset):
    def __init__(self, datadir, split='train', flag_20=False, downsample=4, is_stack=False, hold_every=8):
        """
    ...
    def read_meta(self):
        ...
        if self.flag_20:
            img_list = np.arange(len(self.poses))
