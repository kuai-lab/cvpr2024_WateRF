...
def config_parser(cmd=None):
    ...
    parser.add_argument("--test_save_name", type=str, default='ep')
    ...
    parser.add_argument("--msg_decoder_path", type=str, default= "", help="Path to the decoder for the watermarking model")
    
    parser.add_argument("--loss_i", type=str, default="watson-vgg", help="Type of loss for the image loss. Can be watson-vgg, mse, watson-dft, etc.")
    parser.add_argument("--loss_w", type=str, default="bce", help="Type of loss for the watermark loss. Can be mse or bce")

    parser.add_argument("--lambda_i", type=float, default=1, help="Weight of the image loss in the total loss")
    parser.add_argument("--lambda_tv", type=float, default=0.02, help="Weight of the image loss in the total loss")
    parser.add_argument("--lambda_ssim", type=float, default=0.06, help="Weight of the image loss in the total loss")
    parser.add_argument("--lambda_l1", type=float, default=0.1, help="Weight of the image loss in the total loss")
    
    parser.add_argument("--epoch", type=int, default=10, help="finetuning epoch")
    parser.add_argument("--val_num", type=int, default=3, help="Number of images to use for validation")
    parser.add_argument("--dwt_level", type=int, default=2, help="DWT Level")
    parser.add_argument("--dwt_wave", type=str, default='bior4.4', help="DWT Wave")
    parser.add_argument("--dwt_mode", type=str, default='periodization', help="DWT Mode")
